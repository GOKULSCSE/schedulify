...
const DEFAULT_GLOW_COLOR = '0, 46, 137';
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section p-3 w-full select-none relative"
      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgba(0, 46, 137, 1);
            --purple-glow: rgba(0, 46, 137, 0.2);
            --purple-border: rgba(0, 46, 137, 0.8);
          }
